...
public class SudokuData : MonoBehaviour
{
   ...
   private void Start()
   {
      ...
      sudokuGame.Add("HEARD",SudokuHeardData.GetData());
      sudokuGame.Add("VERY_HEARD",SudokuVeryHeardData.GetData());
   }
}
...
public class SudokuEasyData: MonoBehaviour
{
   ...
   {
      var data = new List<SudokuData.SudokuBordData>
      {
         new(
...
public class SudokuHeardData: MonoBehaviour
{
   public static List<SudokuData.SudokuBordData> GetData()
   {
      var data = new List<SudokuData.SudokuBordData>
...
public class SudokuVeryHeardData: MonoBehaviour
{
   public static List<SudokuData.SudokuBordData> GetData()
   {
